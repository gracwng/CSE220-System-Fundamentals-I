...
//         system("cp /tmp/exp_single_line.txt /workspaces/cse220_hw2/tests/actual_outputs/exp_single_line.txt");
// system("cp /tmp/act_single_line.txt /workspaces/cse220_hw2/tests/actual_outputs/act_single_line.txt");
